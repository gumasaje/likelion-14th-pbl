        ...
        while (true) {
            ...
            switch (command) {
                ...
                case 2:
                    ...
                    if (list.isEmpty()) {
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            Role member = list.get(i);
                            System.out.printf("%d. [%s] %s - %d기\n", i + 1, member.getRoleName(), member.getName(), member.getGeneration());
                        }
                ...
                case 3:
                    ...
                    for (Role role : list) {
                        if (role.getName().equals(findName)) {
                            System.out.println("\n✨ [검색 결과]");
                            System.out.println(role.getProfile());
                            
                            String canSubmit = role.canSubmitByAll() ? "✅ 가능" : "❌ 불가능";
